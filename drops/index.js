...
function updateTimes(){
    ...
    if(moment().tz('Asia/Tokyo').format('H')>12 && moment().tz('Asia/Tokyo').format('H')<23){
        document.getElementById("timesNote").innerHTML = "일판의 이벤트는 12:00 ~ 23:00까지만 진행됩니다.<br><b>현재 일판의 이벤트가 활성화되어 있습니다.<b>";
    }else{
         document.getElementById("timesNote").innerHTML = "일판의 이벤트는 12:00 ~ 23:00까지만 진행됩니다.<br><b>현재 일판의 이벤트가 비활성화되어 있습니다.<b>";
    }
    tt=refreshTimer();
}
